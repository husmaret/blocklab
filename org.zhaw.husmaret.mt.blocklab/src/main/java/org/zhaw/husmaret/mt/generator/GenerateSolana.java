...
public class GenerateSolana extends AbstractBlockchainGenerator {
	
	public GenerateSolana(BlockLabVersion blocklabVersion, Contract contract, ParsedObjects parsedObjects, IFileSystemAccess2 fsa) {
		super(blocklabVersion, contract, parsedObjects, fsa);
	}

	protected void generateSmartContractCode() {
		addLineToCode(0, "Solana");
	}
