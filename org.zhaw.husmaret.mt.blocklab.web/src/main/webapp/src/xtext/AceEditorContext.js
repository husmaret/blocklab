	...
	AceEditorContext.prototype = {
		...
		getText: function(start, end) {
			...
			if (start && end) {
				...
				return session.getTextRange(new ace.Range(startPos.row, startPos.column, endPos.row, endPos.column));
			} else {
		...
		setSelection: function(selection) {
			if (this._editor.selection) {
				...
				this._editor.selection.setSelectionRange(new ace.Range(startPos.row, startPos.column, endPos.row, endPos.column));
			}
		},
		...
		setText: function(text, start, end) {
			...
			session.replace(new ace.Range(startPos.row, startPos.column, endPos.row, endPos.column), text);
